function [Group] = WPMatMHKS_test(WPMatStruct,test_data_final,label_one,label_two,M_row,M_col)

%用于测试WPMatMHKS的代码
%WPMatStruct：含有用于当前测试的训练数据的结构体
...
for p_test = 1:size(test_data_final,1)
    ...
    class_tag = WPMatStruct.u'*B*WPMatStruct.v;
    if class_tag >= 0
