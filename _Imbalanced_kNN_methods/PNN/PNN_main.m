function PNN_main(data_index,ktimes,k)

%计算不平衡数据集的PNN算法

load Imbalanced_data.mat;
dataname =  strcat('PNN_',Imbalanced_data{data_index,1},'_k_',num2str(k));%转存的文件名
...
for i_cv = 1:ktimes
   ...
   [vec_res] = PNN_test(train_all,test_all,k,delta,z);
