function SMOTEBoost_main(dataset_name, data_index, par)
...
for i_cv = 1:par.ktimes    
    ...
    % 训练&测试&记录
    [method, clf_name] = SMOTEBoost_train(train_all, par);
...
final_name = strcat('SMOTEBoost_',file_name,'_iter',num2str(par.T),'_',clf_name);
