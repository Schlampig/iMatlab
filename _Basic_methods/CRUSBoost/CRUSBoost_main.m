function CRUSBoost_main(dataset_name, data_index, par)
...
for i_cv = 1:par.ktimes    
    ...
    % 训练&测试&记录
    [method, clf_name] = CRUSBoost_train(train_all, par);
...
final_name = strcat('CRUSBoost_',file_name,'_iter',num2str(par.T),'_k',num2str(par.k),'_ratio',num2str(par.ratio),clf_name);
