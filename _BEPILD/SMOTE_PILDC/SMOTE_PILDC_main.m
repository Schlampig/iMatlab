function SMOTE_PILDC_main(data_index,ktimes,dp_index,beta)
...
dataname =  strcat('PILDC_dp_',num2str(dp_index),'_',Imbalanced_data{data_index,1},'_SMOTE_beta_',num2str(beta));%转存的文件名
...
for i_cv = 1:ktimes
   ...
   [w,w0,bpos,bneg,candi_dis_pos,candi_dis_neg] = SMOTE_PILDC_train(train_all,dp_index);
   [vec_res] = SMOTE_PILDC_test(test_all,w,w0,bpos,bneg,candi_dis_pos,candi_dis_neg);
