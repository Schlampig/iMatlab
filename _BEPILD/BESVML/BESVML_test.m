function [vec_res] = BESVML_test(test_all,model)
...
for i_test = 1:row_test   
    ...
    ypos = svmlpre(x, mat_sv, vec_alpha, bpos);
    yneg = svmlpre(x, mat_sv, vec_alpha, bneg);
    ...
    elseif ypos >= 0%比右侧分类面更右侧
        ...
        elseif p_pos < p_neg
            ...
            y = svmlpre(x, mat_sv, vec_alpha, b);
            if y >= 0;%是正类
                label_temp = 1;
            else%是负类
                label_temp = 0;
